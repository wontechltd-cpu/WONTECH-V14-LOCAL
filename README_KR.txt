WONTECH 업무메모 + 견적작성 + 발주관리 + 견적관리 + 재고관리 + ASAP관리 통합 V14.3.1 - Windows Local
...
- 재고관리: 제품 사진 첨부·삭제, 고유번호, 품명/규격/단가, 재고/매입/불출수량, 사용처·사유별 불출 이력
- ASAP관리: 제품 사진, ASAP내용, 요청회사, 담당자, 요청일/처리일, 요청금액/확정금액, 완료 목록 자동 이동
...
3. release 폴더 안의 WONTECH_업무관리_V14_14.3.1_x64.exe 사용
