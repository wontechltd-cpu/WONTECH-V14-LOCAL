WONTECH 업무메모 + 견적작성 + 발주관리 + 견적관리 통합 V14.1.5 - Windows Local
...
- 자주 쓰는 폴더: 메인 상단의 폴더1~폴더10 버튼으로 PC의 지정 폴더 바로 열기
...
3. release 폴더 안의 WONTECH_업무관리_V14_14.1.5_x64.exe 사용
...
[자주 쓰는 폴더 사용]
1. 메인 화면의 폴더1~폴더10 중 원하는 버튼을 처음 누릅니다.
2. Windows 폴더 선택창에서 연결할 폴더를 선택합니다.
3. 다음부터 같은 버튼을 누르면 지정한 폴더가 바로 열립니다.
4. 연결 폴더를 바꾸려면 해당 폴더 버튼을 마우스 오른쪽 버튼으로 누릅니다.
