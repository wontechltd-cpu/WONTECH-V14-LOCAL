WONTECH 업무메모 + 견적작성 + 발주관리 + 견적관리 통합 V14.1.3 - Windows Local
...
- 자주 쓰는 링크: 항상 위 옆에 링크 버튼 6개, 링크설정에서 버튼 이름과 웹주소 수정
...
3. release 폴더 안의 WONTECH_업무관리_V14_14.1.3_x64.exe 사용
...
2. 링크 1~6의 버튼 이름과 웹사이트 주소를 입력합니다.
3. '저장'을 누르면 항상 위 옆의 링크 버튼 이름이 변경됩니다.
4. 등록한 버튼을 누르면 해당 웹사이트가 열립니다.
