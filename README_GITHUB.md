...
- 재고관리: 사진 드래그 첨부, 고유번호, 단가, 재고/매입/불출수량, 매입·불출 이력관리
- 매입 등록: 날짜·수량·매입처·메모 기록, 누적 매입수량 및 현재 재고 자동 증가
- 재고관리 저장: 현재 재고 목록 또는 입출고 이력을 엑셀/JPG/PDF A4 가로형으로 저장
- 재고관리 프린트: 현재 재고 목록 또는 입출고 이력을 A4 가로로 인쇄
- ASAP관리: 사진 버튼/드래그 첨부, 요청회사/담당자, 요청/확정금액, 미처리/완료 목록 자동 분류
